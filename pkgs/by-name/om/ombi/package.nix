...
stdenv.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    mkdir -p $out/{bin,share/ombi-${finalAttrs.version}}
    cp -r * $out/share/ombi-${finalAttrs.version}

    makeWrapper $out/share/ombi-${finalAttrs.version}/Ombi $out/bin/Ombi \
      ...
      --chdir "$out/share/ombi-${finalAttrs.version}"
  '';
