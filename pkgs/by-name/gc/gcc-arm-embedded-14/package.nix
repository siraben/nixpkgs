...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "https://developer.arm.com/-/media/Files/downloads/gnu/${finalAttrs.version}/binrel/arm-gnu-toolchain-${finalAttrs.version}-${finalAttrs.platform}-arm-none-eabi.tar.xz";
