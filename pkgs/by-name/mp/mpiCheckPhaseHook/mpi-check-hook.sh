...
setupMpiCheck() {
  ...
  case $mpiType in
    openmpi)
      ...
      # OpenMPI gets confused by the sandbox environment and spews errors like this (both to stdout and stderr):
      ...
      # These messages contaminate test output, which makes the difftest fail.
