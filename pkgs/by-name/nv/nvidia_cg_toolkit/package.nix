...
stdenv.mkDerivation (finalAttrs: {
  ...
  src =
    if stdenv.hostPlatform.system == "x86_64-linux" then
      fetchurl {
        url = "https://developer.download.nvidia.com/cg/Cg_${finalAttrs.version}/Cg-${finalAttrs.version}_${finalAttrs.date}_x86_64.tgz";
        sha256 = "e8ff01e6cc38d1b3fd56a083f5860737dbd2f319a39037528fb1a74a89ae9878";
      }
    else if stdenv.hostPlatform.system == "i686-linux" then
      fetchurl {
        url = "http://developer.download.nvidia.com/cg/Cg_${finalAttrs.version}/Cg-${finalAttrs.version}_${finalAttrs.date}_x86.tgz";
