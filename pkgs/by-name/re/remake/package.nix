...
stdenv.mkDerivation (finalAttrs: {
  ...
  remakeVersion = "4.3";
  dbgVersion = "1.6";
  version = "${finalAttrs.remakeVersion}+dbg-${finalAttrs.dbgVersion}";

  src = fetchurl {
    url = "mirror://sourceforge/project/bashdb/remake/${finalAttrs.version}/remake-${finalAttrs.remakeVersion}+dbg-${finalAttrs.dbgVersion}.tar.gz";
