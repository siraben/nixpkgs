...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchzip {
    url = "https://nsscprodmedia.blob.core.windows.net/prod/software-and-other-downloads/sdks/nrf5/binaries/nrf5_sdk_${finalAttrs.version}_${finalAttrs.urlHash}.zip";
