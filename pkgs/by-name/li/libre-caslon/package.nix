...
stdenv.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    mkdir -p $out/share/doc/libre-caslon-${finalAttrs.version}
    ...
    cp -v libre-caslon-text-${finalAttrs.version}-src/README.md libre-caslon-text-${finalAttrs.version}-src/FONTLOG.txt $out/share/doc/libre-caslon-${finalAttrs.version}
  '';
