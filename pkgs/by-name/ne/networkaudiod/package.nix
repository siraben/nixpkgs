  ...
  src =
    {
      x86_64-linux = fetchurl {
        url = "https://www.signalyst.eu/bins/naa/linux/buster/networkaudiod_${finalAttrs.version}_amd64.deb";
        sha256 = "sha256-un5VcCnvCCS/KWtW991Rt9vz3flYilERmRNooEsKCkA=";
      };
      aarch64-linux = fetchurl {
        url = "https://www.signalyst.eu/bins/naa/linux/buster/networkaudiod_${finalAttrs.version}_arm64.deb";
