...
buildPythonPackage (finalAttrs: {
  ...
  meta = {
    ...
    changelog = "https://github.com/Azure/azure-sdk-for-python/blob/azure-mgmt-containerservice_${finalAttrs.version}/sdk/containerservice/azure-mgmt-containerservice/CHANGELOG.md";
