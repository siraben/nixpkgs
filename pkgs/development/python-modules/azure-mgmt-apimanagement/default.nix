...
buildPythonPackage (finalAttrs: {
  ...
  meta = {
    ...
    changelog = "https://github.com/Azure/azure-sdk-for-python/blob/azure-mgmt-apimanagement_${finalAttrs.version}/sdk/apimanagement/azure-mgmt-apimanagement/CHANGELOG.md";
