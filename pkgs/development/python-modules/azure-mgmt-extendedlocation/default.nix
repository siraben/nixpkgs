...
buildPythonPackage (finalAttrs: {
  ...
  meta = {
    ...
    changelog = "https://github.com/Azure/azure-sdk-for-python/tree/azure-mgmt-extendedlocation_${finalAttrs.version}/sdk/extendedlocation/azure-mgmt-extendedlocation";
