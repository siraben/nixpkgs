...
buildPythonPackage (finalAttrs: {
  ...
  meta = {
    ...
    changelog = "https://github.com/Azure/azure-sdk-for-python/tree/azure-mgmt-appconfiguration_${finalAttrs.version}/sdk/appconfiguration/azure-mgmt-appconfiguration/CHANGELOG.md";
