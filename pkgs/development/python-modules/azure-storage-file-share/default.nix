...
buildPythonPackage (finalAttrs: {
  ...
  meta = {
    ...
    changelog = "https://github.com/Azure/azure-sdk-for-python/blob/azure-storage-file-share_${finalAttrs.version}/sdk/storage/azure-storage-file-share/CHANGELOG.md";
