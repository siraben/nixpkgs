...
buildPythonPackage (finalAttrs: {
  ...
  meta = {
    ...
    changelog = "https://github.com/Azure/azure-sdk-for-python/blob/azure-storage-file-datalake_${finalAttrs.version}/sdk/storage/azure-storage-file-datalake/CHANGELOG.md";
