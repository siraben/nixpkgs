...
mapAliases {
  ...
  tt-rss-plugin-ff-instagram = throw "'tt-rss-plugin-ff-instagram' has been removed because it is incompatible with current TT-RSS and the plugin is no longer maintained."; # Added 2026-09-02
