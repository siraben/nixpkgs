...
mapAliases {
  ...
  _2048-cli-terminal = throw "'_2048-cli-terminal' has been removed due to archived upstream. Consider using '_2048-in-terminal' instead."; # Added 2025-06-07
  ...
  acd-cli = throw "acd-cli has been removed as it was unmaintained"; # Added 2026-05-02
  adb-sync = throw "'adb-sync' has been removed. Use 'better-adb-sync' instead."; # Added 2026-09-04
  adjustor = throw "adjustor has been removed as it is part of the 'handheld-daemon' package"; # Added 2025-11-16
  ...
  bintoolsDualAs = throw "bintoolsDualAs has been removed because it was only useful on `x86_64-darwin` and also only useful for the GNAT bootstrap and also not even used for that any more and actually what on earth were you using this thing for anyway?"; # Added 2026-06-27
  ...
  bitwarden_rs-vault = throw "'bitwarden_rs-vault' has been renamed to/replaced by 'vaultwarden.webvault'"; # Converted to throw 2025-10-27
  ...
  buck = throw "'buck' has been removed as it was deprecated and archived upstream. Consider moving to buck2"; # Added 2026-01-16
  ...
  cargo-pgrx_0_12_6 = throw "'cargo-pgrx_0_12_6' has been removed as it is no longer used in Nixpkgs."; # Added 2026-09-05
  ...
  cereal_1_3_0 = throw "cereal_1_3_0 has been removed as it was unused; use cereal instead"; # Added 2025-09-12
  ...
  charis-sil = throw "'charis-sil' has been renamed to/replaced by 'charis'"; # Added 2025-12-01
  ...
  ciscoPacketTracer7 = throw "'ciscoPacketTracer7' has been removed in favor of 'cisco-packet-tracer_9'";
  ciscoPacketTracer8 = throw "'ciscoPacketTracer8' has been removed as it vendored Qt 5 WebEngine. Consider updating to 'cisco-packet-tracer_9' instead."; # Added 2026-02-08
  ...
  corepack_20 = throw "'corepack_20' has been removed because Node.js 20 reached end-of-life";
  ...
  cpp-netlib = throw "'cpp-netlib' has been removed as it was unmaintained upstream and relied on several outdated versions of dependencies."; # Added 2026-08-25
  ...
  darkly-qt5 = throw "'darkly-qt5' has been removed due to outdated KF5 dependencies"; # Added 2026-05-01
  ...
  devmem2 = throw "'devmem2' has been removed because it was broken and unmaintained. Consider using the devmem command from 'busybox' or 'toybox'."; # Added 2026-07-24
  ...
  docui = throw "'docui' has been removed as it was deprecated and archived upstream. Consider using lazydocker instead"; # Added 2026-01-16
  ...
  dsd = throw "dsd has been removed, as it was broken and lacked upstream maintenance"; # Added 2025-08-25
  ...
  duckstation-bin = throw "'duckstation-bin' has been removed following an upstream request. Please use the AppImage instead"; # Added 2025-09-20
  ...
  ecl_16_1_2 = throw "'ecl_16_1_2' has been removed as it is no longer used in Nixpkgs."; # Added 2026-09-05
  ecryptfs = throw "'ecryptfs' has been removed due to lack of maintenance. Consider using 'gocryptfs' instead."; # Added 2026-01-14
  ...
  emacs30 = throw "'emacs30' has been superseded by 'emacs' in August 2026"; # Added 2026-08-25
  emacs30-gtk3 = throw "'emacs30-gtk3' has been superseded by 'emacs-gtk' in August 2026"; # Added 2026-08-25
  emacs30-nox = throw "'emacs30-nox' has been superseded by 'emacs-nox' in August 2026"; # Added 2026-08-25
  emacs30-pgtk = throw "'emacs30-pgtk' has been superseded by 'emacs-pgtk' in August 2026"; # Added 2026-08-25
  ...
  emojione = throw "emojione has been removed, as it has been archived upstream."; # Added 2025-11-06
  ...
  f3d_egl = warnAlias "'f3d' now builds with EGL support by default, so `f3d_egl` is deprecated; consider using 'f3d' instead." f3d; # Added 2025-07-18
  ...
  fetchmtn = throw "fetchmtn has been removed as it is not used in-tree and the only publicly-readable Monotone network server might be now Monotone's source code itself (which is a bootstrapping problem). Use local checkouts or locally vendor/adapt a copy from an older Nixpkgs checkout."; # Added 2026-08-22
  ...
  foxtrotgps = throw "'foxtrotgps' has been removed as it depended on the deprecated GTK2 engine and the archived GNOME 2 libglade."; # Added 2026-07-23
  ...
  gencfsm = throw "'gencfsm' has been removed as it depends on encfs, which depends on the deprecated fuse2"; # Added 2026-05-05
  ...
  gnome2.libart_lgpl = throw "gnome2.libart_lgpl has been removed as it was deprecated upstream and unused in Nixpkgs"; # Added 2026-07-23
  ...
  goocanvas = throw "'goocanvas' has been removed, as it relied on GTK 2 libraries"; # Added 2026-01-17
  ...
  helix-gpt = throw "helix-gpt was deprecated in January 2026 and has since been removed"; # Added 2026-02-05
  heptabase = throw "'heptabase' has been removed due to lack of maintenance."; # Added 2026-05-31
  ...
  ir.lv2 = ir-lv2; # Added 2025-09-27
  ...
  jami-client-qt = throw "'jami-client-qt' has been renamed to/replaced by 'jami'"; # Converted to throw 2025-10-27
  ...
  kdeltachat = throw "'kdeltachat' has been removed as it depended on EOL qt5 webengine and was unmaintained"; # Added 2026-04-17
  ...
  libdevil-nox = throw "'libdevil-nox' has been removed, as it was unmaintained in Nixpkgs and upstream since 2017"; # Added 2025-09-16
  libdisplay-info_0_2 = throw "`libdisplay-info_0_2` has been removed as it was unused in Nixpkgs. Consider upgrading to `libdisplay-info_0_3` or `libdisplay-info` instead"; # Added 2026-08-04
  ...
  libldac-dec = warnAlias "'libldac-dec' has been replaced by 'ldacbt'" ldacbt; # Added 2026-09-05
  ...
  libreoffice-fresh = warnAlias "LibreOffice upstream has changed the versioning, please use `libreoffice-stable`" libreoffice-stable; # Added 2026-08-11
  libreoffice-fresh-unwrapped = libreoffice-stable-unwrapped; # Added 2026-09-05
  ...
  libreoffice-qt-fresh = warnAlias "LibreOffice upstream has changed the versioning, please use `libreoffice-qt-stable`" libreoffice-qt-stable; # Added 2026-08-11
  libreoffice-qt-fresh-unwrapped = libreoffice-qt-stable-unwrapped; # Added 2026-08-11
  libreoffice-qt-still = warnAlias "LibreOffice upstream has changed the versioning, please use `libreoffice-qt-stable`" libreoffice-qt-stable; # Added 2026-08-11
  libreoffice-qt-still-unwrapped = libreoffice-qt-stable-unwrapped; # Added 2026-08-11
  libreoffice-still = warnAlias "LibreOffice upstream has changed the versioning, please use `libreoffice-stable`" libreoffice-stable; # Added 2026-08-11
  libreoffice-still-unwrapped = libreoffice-stable-unwrapped; # Added 2026-09-05
  ###
  libressl_4_1 = throw "'libressl_4_1' has been removed as it is end-of-life."; # Added 2026-09-05
  ...
  libsoup = throw "'libsoup' has been removed because it referred to EOL libsoup 2.4, which has known unfixed security issues. Consider migrating to 'libsoup_3' instead"; # Converted to throw 2025-10-27
  ...
  linuxPackages_xen_dom0_hardened = throw "'linuxPackages_xen_dom0_hardened' has been removed due to lack of maintenance"; # Converted to throw 2025-10-27
  ...
  littlefs-fuse = throw "'littlefs-fuse' has been removed as it depends on fuse2, which has been deprecated"; # Added 2026-05-05
  ...
  lukesmithxyz-st = throw "'lukesmithxyz-st' has been removed, as it is unmaintained"; # Added 2026-08-31
  ...
  lxde.lxappearance-gtk2 = throw "'lxde.lxappearance-gtk2' has been removed because it depended on GTK 2. Consider using 'lxappearance' instead."; # Added 2025-08-31
  ...
  marwaita-manjaro = throw "'marwaita-manjaro' has been removed because it depended on 'gtk-engine-murrine', which was removed because it was unmaintained upstream and depended on GTK 2."; # Converted to throw 2025-10-27
  ...
  marwaita-peppermint = throw "'marwaita-peppermint' has been removed because it depended on 'gtk-engine-murrine', which was removed because it was unmaintained upstream and depended on GTK 2."; # Converted to throw 2025-10-27
  marwaita-pop_os = throw "'marwaita-pop_os' has been removed because it depended on 'gtk-engine-murrine', which was removed because it was unmaintained upstream and depended on GTK 2."; # Converted to throw 2025-10-27
  ...
  marwaita-ubuntu = throw "'marwaita-ubuntu' has been removed because it depended on 'gtk-engine-murrine', which was removed because it was unmaintained upstream and depended on GTK 2."; # Converted to throw 2025-10-27
  ...
  materia-theme-transparent = throw "'materia-theme-transparent' has been removed because it depended on 'gtk-engine-murrine', which was removed because it was unmaintained upstream and depended on GTK 2."; # Added 2026-07-22
  ...
  midori-unwrapped = throw "'midori-unwrapped' has been removed because the original Midori project was abandoned upstream and the package had been broken in Nixpkgs"; # Added 2025-05-19
  ...
  mkYarnModules = throw "'mkYarnModules' has been removed with yarn2nix, as its tooling was unusable within nodePackages. Use the standard Yarn v1 hooks available in Nixpkgs instead."; # Added 2026-04-25
  mkYarnPackage = throw "'mkYarnPackage' has been removed with yarn2nix, as its tooling was unusable within nodePackages. Use the standard Yarn v1 hooks available in Nixpkgs instead."; # Added 2026-04-25
  ...
  mongodb-6_0 = throw "mongodb-6_0 has been removed, as it reached end-of-life in July 2025"; # Added 2025-07-23
  ...
  mozart2-binary = throw "'mozart2-binary' has been removed, as it was an unmaintained 2018 alpha snapshot superseded by 'mozart2'"; # Added 2026-09-05
  ...
  n98-magerun = throw "n98-magerun doesn't support PHP newer than 8.1"; # Added 2025-10-03
  ...
  nim2 = throw "'nim2' has been upgraded and removed, please use 'nim'"; # Added 2026-09-05
  nim-1_0 = throw "'nim-1_0' has reached EOL, please use 'nim'"; # Added 2026-09-05
  nim-2_0 = throw "'nim-2_0' has been upgraded and removed, please use 'nim'"; # Added 2026-09-05
  nim-2_2 = throw "'nim-2_2' has been upgraded and removed, please use 'nim'"; # Added 2026-09-05
  nim-unwrapped-1 = throw "'nim-unwrapped-1' has reached EOL, please use 'nim-unwrapped'"; # Added 2026-03-06
  nim-unwrapped-1_0 = throw "'nim-unwrapped-1_0' has reached EOL, please use 'nim-unwrapped'"; # Added 2026-09-05
  ...
  nodejs-slim_20 = throw "'nodejs-slim_20' has been removed because Node.js 20 reached end-of-life";
  nodejs-slim_25 = throw "'nodejs-slim_25' has been removed because Node.js 25 reached end-of-life";
  ...
  nushell-plugin-bson = warnAlias "'nushell-plugin-bson' has been renamed to 'nushellPlugins.bson'" nushellPlugins.bson; # Added 2026-09-05
  nushell-plugin-dbus = warnAlias "'nushell-plugin-dbus' has been renamed to 'nushellPlugins.dbus'" nushellPlugins.dbus; # Added 2026-09-05
  nushell-plugin-desktop_notifications = warnAlias "'nushell-plugin-desktop_notifications' has been renamed to 'nushellPlugins.desktop_notifications'" nushellPlugins.desktop_notifications; # Added 2026-09-05
  nushell-plugin-formats = warnAlias "'nushell-plugin-formats' has been renamed to 'nushellPlugins.formats'" nushellPlugins.formats; # Added 2026-09-05
  nushell-plugin-gstat = warnAlias "'nushell-plugin-gstat' has been renamed to 'nushellPlugins.gstat'" nushellPlugins.gstat; # Added 2026-09-05
  nushell-plugin-hcl = warnAlias "'nushell-plugin-hcl' has been renamed to 'nushellPlugins.hcl'" nushellPlugins.hcl; # Added 2026-09-05
  nushell-plugin-highlight = warnAlias "'nushell-plugin-highlight' has been renamed to 'nushellPlugins.highlight'" nushellPlugins.highlight; # Added 2026-09-05
  nushell-plugin-net = warnAlias "'nushell-plugin-net' has been renamed to 'nushellPlugins.net'" nushellPlugins.net; # Added 2026-09-05
  nushell-plugin-polars = warnAlias "'nushell-plugin-polars' has been renamed to 'nushellPlugins.polars'" nushellPlugins.polars; # Added 2026-09-05
  nushell-plugin-query = warnAlias "'nushell-plugin-query' has been renamed to 'nushellPlugins.query'" nushellPlugins.query; # Added 2026-09-05
  nushell-plugin-semver = throw "'nushell-plugin-semver' has been removed because Nushell now supports semantic versions natively."; # Added 2026-09-05
  nushell-plugin-skim = warnAlias "'nushell-plugin-skim' has been renamed to 'nushellPlugins.skim'" nushellPlugins.skim; # Added 2026-09-05
  nushell-plugin-units = warnAlias "'nushell-plugin-units' has been renamed to 'nushellPlugins.units'" nushellPlugins.units; # Added 2026-09-05
  ...
  oam-tools = throw "'oam-tools' has become part of amass"; # Added 2025-12-21
  ...
  onlyoffice-bin_latest = throw "'onlyoffice-bin_latest' has been renamed to/replaced by 'onlyoffice-desktopeditors'"; # Converted to throw 2025-10-27
  ...
  onthespot = throw "onthespot has been removed due to lack of upstream maintenance"; # Added 2025-09-26
  ...
  openexrid-unstable = throw "'openexrid-unstable' has been removed as it had several insecure dependencies and had minimal upstream maintenance"; # Added 2026-08-28
  ...
  openmodelica = throw "'openmodelica' has been removed as it was unmaintained in Nixpkgs and depended on insecure and unmaintained qtwebkit"; # Added 2026-04-26
  ...
  opentracing-cpp = throw "'opentracing-cpp' has been removed as it was archived upstream in 2024"; # Added 2025-10-19
  ...
  osgqt = throw "'osgqt' has been removed as it was unused and depended on EOL Qt 5"; # Added 2026-08-15
  ...
  overseerr = warnAlias "'overseerr' has been renamed to 'seerr'" seerr; # Added 2026-09-05
  ...
  parcellite = throw "'parcellite' was removed due to lack of maintenance and reliance on GTK 2"; # Added 2025-10-03
  ...
  pcmanx-gtk2 = throw "'pcmanx-gtk2' has been removed as GTK 2 has reached end-of-life"; # Added 2026-03-19
  ...
  perceptualdiff = throw "perceptualdiff was removed due to numerous vulnerabilities in freeimage"; # Added 2025-10-23
  ...
  petrifoo = throw "'petrifoo' was removed due to lack of maintenance and reliance on GTK 2"; # Added 2025-12-02
  pfixtools = throw "'pfixtools' has been removed as it is unmaintained upstream. Consider using 'postsrsd' instead."; # Added 2026-09-05
  ...
  postgresql13JitPackages = throw "'postgresql13JitPackages' has been removed because PostgreSQL 13 reached end-of-life"; # Converted to throw 2025-10-27
  ...
  protobuf3_24 = throw "'protobuf3_24' has been removed from Nixpkgs. Consider using 'protobuf' instead"; # Added 2025-07-14
  ...
  pyCA = throw "'pyCA' has been removed because it was hard to maintain and not required by anything"; # Added 2026-02-12
  pyca = throw "'pyca' was removed, because it was hard to maintain and not required by anything"; # Added 2026-07-31
  pylint-exit = throw "'pylint-exit' was removed as it depended on m2r, which was removed."; # Added 2026-05-27
  ...
  pyotherside = warnAlias "'pyotherside' has been renamed to 'libsForQt5.pyotherside'. A Qt6 build is available at 'qt6Packages.pyotherside'." libsForQt5.pyotherside; # Added 2026-03-27
  ...
  python-qt = throw "python-qt has been removed because it was hard to maintain and not required by anything"; # Added 2025-01-14
  ...
  redoc-cli = throw "'redoc-cli' has been removed because it has been marked as broken since at least November 2024. Consider using 'redocly' instead."; # Added 2025-10-01
  ...
  rofi-pass-wayland = throw "'rofi-pass-wayland' has been removed as it is unmaintained upstream."; # Added 2026-09-05
  ...
  ruby_3_1 = throw "ruby_3_1 has been removed, as it has reached end‐of‐life upstream"; # Added 2025-10-12
  ...
  rubyPackages_3_1 = throw "rubyPackages_3_1 has been removed, as it has reached end‐of‐life upstream"; # Added 2025-10-12
  ...
  seq24 = throw "'seq24' has been removed as it was unmaintained upstream and depended on the deprecated GTK 2 engine."; # Added 2026-08-03
  ...
  SkypeExport = throw "'SkypeExport' was removed since Skype was shut down in May 2025"; # Added 2025-09-15
  ...
  smlnjBootstrap = throw "'smlnjBootstrap' has been removed as it is no longer needed."; # Added 2026-09-05
  ...
  spectrojack = throw "'spectrojack' was removed due to lack of upstream maintenance and reliance on GTK 2"; # Added 2025-12-02
  speed_dreams = speed-dreams; # Added 2026-01-19
  spidermonkey_91 = throw "'spidermonkey_91' has been EOL since 2022/09"; # Added 2025-08-26
  spidermonkey_115 = throw "'spidermonkey_115' has been EOL since 2024/09"; # Added 2026-07-06
  ...
  sqlar = throw "'sqlar' has been removed, as it is unmaintained upstream, and depends on fuse2. Consider using the sqlite builtin VACUUM";
  ...
  ssh-askpass-fullscreen = throw "'ssh-askpass-fullscreen' has been removed as it depended on the deprecated GTK2 engine."; # Added 2026-08-03
  ...
  svt-av1-psy = throw "'svt-av1-psy' has been removed. Upstream suggests 'svt-av1-hdr' instead"; # Added 2026-01-10
  ...
  teamspeak_client = throw "'teamspeak_client' has been removed because 'teamspeak3' depended on EOL Qt 5. Consider using 'teamspeak6-client' instead"; # Converted to throw 2025-10-27
  ...
  tezos-rust-libs = throw "'tezos-rust-libs' has been removed; it was replaced by 'ligo', which has also been removed for lack of maintenance"; # Added 2025-06-03
  ...
  thedesk = throw "'thedesk' has been removed due to lack of maintenance and vendoring an EOL Electron version."; # Added 2025-09-02
  ...
  tokyo-night-gtk = throw "'tokyo-night-gtk' has been removed because it depended on 'gtk-engine-murrine', which was removed because it was unmaintained upstream and depended on GTK 2."; # Converted to throw 2025-10-27
  ...
  twitterBootstrap = warnAlias "'twitterBootstrap' has been renamed to 'twitter-bootstrap'" twitter-bootstrap; # Added 2026-02-12
  ...
  typst-fmt = throw "'typst-fmt' has been removed due to lack of upstream maintenance. Consider using 'typstyle' instead"; # Converted to throw 2025-10-27
  ...
  varnish60 = throw "varnish 6.0 has been removed as it used unmaintained dependencies. Please upgrade to 'varnish80' or 'vinyl-cache_9'."; # Added 2026-05-29
  ...
  vtk_9_egl = warnAlias "'vtk_9_5' now builds with EGL support by default, so `vtk_9_egl` is deprecated; consider using 'vtk_9_5' instead." vtk_9_5; # Added 2025-07-18
  ...
  xf86_input_cmt = throw "'xf86_input_cmt' has been removed as it was broken and unmaintained upstream"; # Added 2025-12-12
  ...
  xplorer = throw "'xplorer' has been removed as it was unmaintained in Nixpkgs and needed upgrading to the experimental Tauri v2 rewrite, as the old version depended on webkitgtk 4.0"; # Added 2026-06-07
  xsw = throw "'xsw' has been removed due to lack of upstream maintenance"; # Added 2025-08-22
  xsynth_dssi = throw "'xsynth_dssi' was removed due to lack of upstream maintenance and reliance on GTK 2"; # Added 2025-12-02
  xtrap = throw "XTrap was a proposed X11 extension that hasn't been in Xorg since X11R6 in 1994, it is deprecated and archived upstream."; # added 2025-12-13
  ...
  yabar-unstable = throw "'yabar-unstable' has been removed as the upstream project was archived"; # Added 2025-06-10
