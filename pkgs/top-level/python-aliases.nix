...
mapAliases {
  ...
  amazon_kclpy = throw "'amazon_kclpy' has been removed because it was broken"; # Converted to throw 2025-10-29
  ...
  asyncstdlib-fw = throw "'asyncstdlib-fw' has been removed as it is no longer required by fireworks-ai"; # Added 2026-06-09
  atenpdu = throw "'atenpdu' has been removed, since it was broken and unmaintained in Home Assistant"; # Added 2026-06-04
  atsim_potentials = throw "'atsim_potentials' has been renamed to/replaced by 'atsim-potentials'"; # Converted to throw 2025-10-29
  aubio = throw "'aubio' has been removed because its only direct user, LedFX, switched to the 'aubio-ledfx' fork."; # Added 2026-04-20
  ...
  autotrash = throw "'autotrash' has been promoted to the top-level attribute 'pkgs.autotrash'"; # Converted to throw 2025-10-29
  ...
  backports-functools-lru-cache = throw "'backports-functools-lru-cache' has been removed from Nixpkgs as it was no longer used in Python 2"; # Added 2026-01-14
  backports_shutil_get_terminal_size = throw "'backports_shutil_get_terminal_size' has been removed, since this backport for Python 3.2 is no longer needed"; # Converted to throw 2025-10-29
  ...
  basswood-av = throw "'basswood-av' has been removed because it was archived upstream and unused"; # added 2025-11-26
  ...
  beewi-smartclim = throw "'beewi-smartclim' was removed because it depends on the unmaintained bluepy library"; # Added 2026-06-04
  betterproto-fw = throw "'betterproto-fw' has been removed as it is no longer required by fireworks-ai"; # Added 2026-06-09
  ...
  bumpfontversion = throw "'bumpfontversion' has been removed as it is no longer used"; # added 2026-08-09
  bunch = throw "bunch has been removed as it is unmaintained since inception"; # added 2025-05-31
  bz2file = throw "'bz2file' has been removed, as it has not been maintained upstream since 2020"; # added 2025-08-26
  ...
  chromaprint = throw "'chromaprint' was removed as it depended on m2r which was removed."; # Added 2026-05-27
  ...
  cython_3_1 = throw "'cython_3_1' has been removed; use 'cython' instead."; # Added 2026-09-05
  ...
  datauri = warnAlias "'datauri' has been renamed to 'python-datauri'" python-datauri; # Added 2026-07-28
  ...
  django_3 = throw "Django 3 reached its EOL in 2024-04 and has therefore been removed."; # added 2025-01-25
  django_4 = throw "Django 4 reached its EOL in 2026-04 and has therefore been removed."; # added 2026-03-30
  django_5_1 = throw "Django 5.1 reached its EOL in 2025-12 and has therefore been removed."; # added 2025-11-30
  ...
  django_compat = throw "'django_compat' has been removed because it provided compatibility for Django 1.x, which is long past end-of-life"; # Converted to throw 2025-10-29
  ...
  django_hijack_admin = throw "'django_hijack_admin' has been removed because it was no longer compatible with django-hijack"; # Converted to throw 2025-10-29
  ...
  django_nose = throw "'django_nose' has been removed because it was unmaintained and unused"; # Converted to throw 2025-10-29
  ...
  easyeda2ato = throw "'easyeda2ato' has been removed in favor of 'atopile-easyeda2kicad'"; # added 2025-06-08
  ...
  eliqonline = throw "'eliqonline' was removed because Home Assistant dropped the integration"; # Added 2026-06-04
  ...
  f3d_egl = lib.warnOnInstantiate "'f3d' now builds with EGL support by default, so `f3d_egl` is deprecated; consider using 'f3d' instead." f3d; # added 2025-07-18
  ...
  fatrop = throw "'fatrop' has been removed from the Python package set because upstream no longer provides Python bindings."; # Added 2026-09-05
  ...
  fortune = warnAlias "'fortune' has been renamed to 'fortune-python'" fortune-python; # Added 2026-09-05
  ...
  gtimelog = throw "'python3Packages.gtimelog' has moved to 'pkgs.gtimelog'"; # Converted to throw 2025-10-29
  ...
  lazy_import = throw "'lazy_import' has been removed because 'lazy-import' was unused"; # Converted to throw 2025-10-29
  ...
  llamaindex-py-client = throw "'llamaindex-py-client' has been removed as it was removed from upstream"; # Added 2026-04-03
  llfuse = throw "'llfuse' has been removed, as it depends on fuse2 and is no longer developed. Please use 'mfusepy' instead"; # Added 2026-05-20
  ...
  markdown-inline-graphviz = warnAlias "'markdown-inline-graphviz' has been renamed to 'markdown-inline-graphviz-extension'" markdown-inline-graphviz-extension; # Added 2026-09-05
  ...
  MDP = throw "'MDP' has been removed because it was unmaintained and broken"; # Converted to throw 2025-10-29
  ...
  more-properties = throw "'more-properties' has been removed due to lack of upstream maintenance"; # Added 2026-07-14
  ...
  mullvad-closest = throw "'mullvad-closest' has been removed as it was unmaintained."; # Added 2026-01-13
  ...
  netbox-interface-synchronization = throw "'netbox-interface-synchronization' has been moved to the 'netboxPlugins' package set"; # Added 2026-06-13
  ...
  online-judge-verify-helper = throw "'online-judge-verify-helper' has moved to the top-level package set."; # Added 2026-09-05
  open-interpreter = throw "'open-interpreter' has moved to the top-level package set."; # Added 2026-09-05
  ...
  orange-widget-base = throw "'orange-widget-base' has been removed as it was unmaintained and depended on Qt 5 WebEngine"; # Added 2026-02-10
  ...
  patator = throw "'patator' has been removed as it depended on removed packages and was broken"; # Added 2025-12-30
  ...
  pyezviz = throw "pyezviz has been removed in favor of pyezvizapi, where development continues"; # added 2025-06-11
  ...
  pyialarmxr = throw "'pyialarmxr' has been removed together with its component support in Home Assistant"; # Converted to throw 2025-10-29
  ...
  pymedio = throw "pymedio was removed, as it has been archived upstream since 2025. The modules 'dicom-numpy' and 'simpleitk' can be used as alternatives."; # added 2026-09-11
  ...
  PyMVGLive = throw "'PyMVGLive' has been removed because it was unmaintained upstream and non-functional due to API changes"; # Converted to throw 2025-10-29
  pymyq = throw "'pymyq' has been removed because the service provider blocks its API requests"; # Converted to throw 2025-10-29
  ...
  pytest-pep8 = throw "'pytest-pep8' has been removed because it was abandoned and incompatible with modern pytest"; # Converted to throw 2025-10-29
  ...
  pytestrunner = throw "'pytestrunner' has been removed because it relied on the deprecated pytest-runner package"; # Converted to throw 2025-10-29
  ...
  python_openzwave = throw "python_openzwave was removed because openzwave is no longer maintained upstream. Consider using python3Packages.zwave-js-server-python"; # Converted to throw 2025-10-29
  python_simple_hipchat = throw "'python_simple_hipchat' has been removed because it was broken and unmaintained"; # Converted to throw 2025-10-29
  ...
  qds_sdk = throw "'qds_sdk' has been removed because it was unmaintained upstream and depended on the removed boto package"; # Converted to throw 2025-10-29
  qiskit-ibmq-provider = throw "qiskit-ibmq-provider has been removed, since it was deprecated upstream"; # added 2025-09-13
  ...
  sphinx-hoverxref = throw "'sphinx-hoverxref' has been deprecated upstream. Its functionality was merged into the readthedocs.org admin panel."; # Added 2026-01-18
  ...
  sphinxcontrib_newsfeed = throw "'sphinxcontrib_newsfeed' has been removed due to abandonment upstream"; # Converted to throw 2025-10-29
  ...
  sqlalchemy_migrate = throw "'sqlalchemy_migrate' has been removed because it was abandoned upstream and incompatible with SQLAlchemy 2"; # Converted to throw 2025-10-29
  ...
  tensorflow-estimator_2 = throw "'tensorflow-estimator_2' has been renamed to/replaced by 'tensorflow-estimator-bin'"; # Converted to throw 2025-10-29
  ...
  tensorflow-tensorboard_2 = throw "'tensorflow-tensorboard_2' has been renamed to/replaced by 'tensorboard'"; # Converted to throw 2025-10-29
  ...
  Theano = throw "'Theano' has been removed because it is no longer maintained"; # Converted to throw 2025-10-29
  TheanoWithCuda = throw "'TheanoWithCuda' has been removed because it is no longer maintained"; # Converted to throw 2025-10-29
  TheanoWithoutCuda = throw "'TheanoWithoutCuda' has been removed because it is no longer maintained"; # Converted to throw 2025-10-29
