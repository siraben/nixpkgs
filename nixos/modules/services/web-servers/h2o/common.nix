{ lib }:
{
  tlsRecommendationsOption = lib.mkOption {
    ...
    description = ''
      ...
      on a per-host basis using services.h2o.hosts.<name>.tls.recommendations.
      The settings will also be overridden by manual values set with
