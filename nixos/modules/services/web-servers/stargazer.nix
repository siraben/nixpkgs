...
in
{
  options.services.stargazer = {
    ...
    connectionLogging = lib.mkOption {
      type = lib.types.bool;
      default = true;
      description = "Whether to log connections to stdout.";
    };
    ...
    allowCgiUser = lib.mkOption {
      ...
      description = ''
        ...
        You will need to create the user mentioned in `cgi-user` if it does not
        already exist.
      '';
    };
    ...
    certLifetime = lib.mkOption {
      ...
      default = "";
      description = ''
        How long certs generated by Stargazer should live.
    ...
    routes = lib.mkOption {
      ...
      default = [ ];
      description = ''
        Routes that Stargazer should serve.
