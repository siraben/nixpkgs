    ...
    services.stash = {
      ...
      mutableSettings = mkOption {
        description = ''
          ...
          If `false`, any config changes done from within the Stash UI will be temporary and reset to those defined in {option}`services.stash.settings` upon `Stash.service` restart.
