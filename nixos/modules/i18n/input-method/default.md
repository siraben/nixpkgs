...
The following input methods are available in NixOS:
  ...
  - Uim: The universal input method, a library with a XIM bridge.
  - Hime: An extremely easy-to-use input method framework.
  - Kime: A Korean IME.

## IBus {#module-services-input-methods-ibus}

IBus is an Intelligent Input Bus. It provides a full-featured and user-friendly
...
Available extra IBus engines are:
  ...
  - mozc (`ibus-engines.mozc`): A Japanese input method from
    Google.
  - Table (`ibus-engines.table`): An input method that loads
...
built-in input method engines: Pinyin, QuWei and table-based input methods.
...
used to choose the uim toolbar.
...
Kime is a Korean IME. It's built with the Rust language and lets you type Korean simply, safely and fast.
