...
- The module type system has a new extensible option types feature that allows certain types, such as enum, to be extended through multiple option declarations of the same option across multiple modules.
