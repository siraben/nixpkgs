...
- [compsize](https://github.com/kilobyte/compsize), setcap wrapper for `compsize` package, a cli utility to inspect compression type/ratio on BTRFS filesystems. Available as [programs.compsize](#opt-programs.compsize.enable)
