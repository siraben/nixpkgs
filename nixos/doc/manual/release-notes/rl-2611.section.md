...
- [compsize](https://github.com/kilobyte/compsize), setcap wrapper for the `compsize` package, a CLI utility to inspect compression type/ratio on Btrfs filesystems. Available as [programs.compsize](#opt-programs.compsize.enable)
...
- [ioquake3](https://ioquake3.org), an open-source port of the 3D action shooter Quake 3 Arena. Available as [programs.ioquake3](#opt-programs.ioquake3.enable).
