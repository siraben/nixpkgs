...
- Plymouth now uses simpledrm immediately by default, avoiding delayed or
  text-mode early prompts. Set
  [`boot.plymouth.useSimpledrm = false`](#opt-boot.plymouth.useSimpledrm) to
