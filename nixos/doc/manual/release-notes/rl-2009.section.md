...
- The installer now enables sshd by default. This improves installation on headless machines especially ARM single-board-computer. To log in through SSH, either a password or an SSH key must be set for the root user or the nixos user.
