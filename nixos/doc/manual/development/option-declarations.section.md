...
Extensible option types are a feature that allows certain type declarations to
be extended through multiple module files. This feature only works with a
